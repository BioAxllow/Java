package _00_Objektinis_Programavimas_2019._17_Parametrizuotos_Klases_Weekend;
...
public class Main {
    public static void main(String[] args) {
        String data = new File("").getAbsolutePath() + "\\src\\_00_Objektinis_Programavimas_2019._17_Parametrizuotos_Klases_Weekend\\Data.txt";
        String dataOutput = new File("").getAbsolutePath() + "\\src\\_00_Objektinis_Programavimas_2019._17_Parametrizuotos_Klases_Weekend\\DataOutput.txt";
...
//        Integer one = skaic[0][0];
//        for (int i = 0; i < seniausias.length; i++) {
//            skaic[0][i]=seniausias[i];
//        }
//
//        Integer two = skaic[1][0];
//        for (int i = 0; i < naujausias.length; i++) {
//            skaic[1][i]=naujausias[i];
//        }
//
//        Integer three = skaic[2][0];
//        for (int i = 0; i < naujesnesNei.length; i++) {
//            skaic[2][i]=naujesnesNei[i];
//        }
//
//        Integer four = skaic[3][0];
//        for (int i = 0; i < specMetuMasinos.length; i++) {
//            skaic[3][i]=specMetuMasinos[i];
//        }
//
//        Integer five = skaic[4][0];
//        for (int i = 0; i < specMarkesMasinos.length; i++) {
//            skaic[4][i]=specMarkesMasinos[i];
//        }
//
//        Integer six = skaic[5][0];
//        for (int i = 0; i < specMetuMasinos.length; i++) {
//            skaic[5][i]=specMetuMasinos[i];
//        }
//
//        Integer seven = skaic[6][0];
//        Integer eight = skaic[7][0];
...
//            }
    ...
    //gauname Main arrgumentu list, suformuota random ilgio indeksu array, ir kuriam main matricos eilutei priskiriam masyva.
...
//    public static Integer[][] pridetiMatricosEilutesElementa(Integer[][] args, Integer indexLocation, Integer argumentLocation){
//        args=Arrays.copyOf(args,args[argumentLocation].length+1);
//        args[argumentLocation][0]=indexLocation;
//        return args;
//    }
